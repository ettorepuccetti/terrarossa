      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Terrarouge.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Terrarouge, accessible from{" "}
            <a
              href="https://terrarouge.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://terrarouge.vercel.app/
            </a>
          </p>
        </li>
        <li>
